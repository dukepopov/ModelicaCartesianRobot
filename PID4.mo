model CBody
  ...
  Modelica.Mechanics.Translational.Components.Damper damper(d = 1000) annotation(
    Placement(transformation(origin = {-58, -120}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(damper.flange_a, prismatic.support) annotation(
    Line(points = {{-68, -120}, {-88, -120}, {-88, -62}, {-48, -62}}, color = {0, 127, 0}));
  connect(damper.flange_b, prismatic.axis) annotation(
    Line(points = {{-48, -120}, {-14, -120}, {-14, -62}, {-36, -62}}, color = {0, 127, 0}));
  annotation(
