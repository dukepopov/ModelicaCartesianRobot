model CBody
  ...
  Modelica.Mechanics.Translational.Components.ElastoGap elastoGap(c = 1e6, d = 100e3, s_rel0 = -2)  annotation(
...
equation
  ...
  connect(elastoGap.flange_b, prismatic.support) annotation(
    Line(points = {{-50, -110}, {-48, -110}, {-48, -62}}, color = {0, 127, 0}));
  connect(constantForce.flange, elastoGap.flange_a) annotation(
    Line(points = {{-106, -110}, {-70, -110}}, color = {0, 127, 0}));
  connect(elastoGap.flange_a, prismatic.axis) annotation(
    Line(points = {{-70, -110}, {-70, -132}, {-36, -132}, {-36, -62}}, color = {0, 127, 0}));
  annotation(
